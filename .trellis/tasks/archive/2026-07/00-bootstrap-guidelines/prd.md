...
- [x] Fill guidelines for @easy-training/api
- [x] Fill guidelines for @easy-training/auth
- [x] Fill guidelines for @easy-training/config
- [x] Fill guidelines for @easy-training/db
- [x] Fill guidelines for @easy-training/env
- [x] Fill guidelines for @easy-training/ui
- [x] Add real code paths and project-specific examples

本次采用轻量入口模式：每个有效 package/layer 的 `index.md` 只记录当前仓库已经存在的边界与高风险约束；未被入口引用的生成式占位文件不作为任务上下文。
